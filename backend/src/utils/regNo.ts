 ...
 */
export function getNextRegNo(lastRegNo: string | null | undefined): string {
  // If nothing is set, start from 1
  if (!lastRegNo || !lastRegNo.trim()) return '1'
 ...
 */
export function previewNextRegNo(lastRegNo: string): string {
